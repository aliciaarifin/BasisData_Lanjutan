...
students = pd.read_csv("Finals_BDL_Streamlit/student_habits_performance.csv")
...
'''
st.code(fitted_dist)
st.image("Finals_BDL_Streamlit/ks_par.png")
st.image("Finals_BDL_Streamlit/dist.png")
